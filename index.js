...
app.get('/random', (req, res) => {
  ...
  var jokesArrLength = jokes.length;
  var random = Math.floor(Math.random() * jokesArrLength);
...
app.delete('/jokes/:id', (req, res) => {
  ...
  if (searchIndex > -1) {
    ...
    res.status(200).json({ message: `Joke with ID ${ id } has been deleted.` });
  } else {
...
app.delete('/all', (req, res) => {
  ...
  if (userKey === masterKey) {
    jokes = [];
    res.status(200).json({ message: `Jokes have been deleted.` });
  } else {
